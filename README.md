...
4) This next portfolio (n = 549, num_symbols = 5, out of sample during coronavirus) was analyzed because of #3's success. The 95% confidence interval for out of sample profits minus SPY profits is as follows: [191,368, 217,021, 242,673]. Like before, we can reject the null hypothesis that this 
